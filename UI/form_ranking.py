...
class Ranking(Form):
    def __init__(self, screen, x: int, y: int, w: int, h: int, color_background, path_image, scoreboard, margen_y, margen_x, espacio, 
        ...
        self.background_img = pygame.image.load("./assets/img/background/scoreboard bg.jpg")
        ...
        self.player_bar = Label(screen=self._slave, x=margen_x+10,y=20,w=w/2-margen_x-10,h=50,text = "Player", font="Verdana",font_size=30,font_color=(255,255,255),path_image="./UI/resources/bar.png")
        self.score_bar = Label(screen=self._slave, x=margen_x+300,y=20,w=w/2-margen_x-10,h=50,text = "Score", font="Verdana",font_size=30,font_color=(255,255,255),path_image="./UI/resources/bar.png")
        self.home_button = Button_Image(screen = self._slave, master_x=x, master_y=y, x = w-70, y = h-70, w = 50, h = 50, path_image = "./UI/resources/home.png", onclick = self.btn_home_click, onclick_param = "")
        ...
        for j in self._score:
            ...
            for n,s in j.items():
                ...
                pos = Label(screen=self._slave, x=pos_inicial_x,y=pos_inicial_y,
                            ...
                            font_color=(255,255,255),path_image="./UI/resources/Table.png")
