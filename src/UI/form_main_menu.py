...
class MainMenu(Form):
    def __init__(self, screen: pygame.Surface, x:int, y:int, w:int, h:int, color_background, color_border: (0,0,0), border_size: int = -1, active = True):
        ...
        self.menu_label = Label(self._slave, 200, 50, 400, 50, "The Evil Guest", "Horrorfind", 36, (155, 0, 0), "./src/assets/img/ui/Table.png")
        ...
        self.background_image = pygame.image.load("./src/assets/img/background/background.jpg")
        self.background_image = pygame.transform.scale(self.background_image, (w, h))

        pygame.mixer.music.load("./src/assets/sounds/bg ost/Resident Evil 4 Remake OST - Main Menu Theme.wav")
    ...
    def on_ranking_click(self, texto):
        ...
        ranking = Ranking(self._master, 0, 0, ANCHO_VENT, ALTO_VENT, NEGRO, "./src/assets/img/ui/Window.png", list_dict_ranking, 10, 100, 10)
        ranking.active = True
