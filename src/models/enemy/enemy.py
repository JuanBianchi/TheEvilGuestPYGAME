...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, enemy_type: str, coord_x, coord_y, frame_rate, walk_speed, run_speed, gravity, constraint_x_right, constraint_x_left,
        ...
        self.screech_sound = pygame.mixer.Sound("./src/assets/sounds/enemy/screech/zombie screech.wav")
        self.attack_sound = pygame.mixer.Sound("./src/assets/sounds/enemy/attack/zombie attack.wav")
        self.death_sound = pygame.mixer.Sound("./src/assets/sounds/enemy/death/zombie death.wav")
